...
def create_database_agent(agent_id: Optional[str] = None) -> DatabaseAgent:
    """Create a Database agent."""
    return AgentFactory.create_agent(AgentType.DATABASE, agent_id)


def create_devops_agent(agent_id: Optional[str] = None) -> DevOpsAgent:
    """Create a DevOps agent."""
    return AgentFactory.create_agent(AgentType.DEVOPS, agent_id)


def create_qa_agent(agent_id: Optional[str] = None) -> QAAgent:
    """Create a QA agent."""
    return AgentFactory.create_agent(AgentType.QA, agent_id)
...
if __name__ == "__main__":
    ...
    db = create_database_agent()
    print(f"\nCreated: {db}")
    print(f"Capabilities: {db.get_capabilities()}")
